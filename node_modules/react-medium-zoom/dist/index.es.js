...
var ReactMediumZoom = function (_Component) {
  inherits(ReactMediumZoom, _Component);

  function ReactMediumZoom() {
    var _ref;

    var _temp, _this, _ret;

    classCallCheck(this, ReactMediumZoom);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ReactMediumZoom.__proto__ || Object.getPrototypeOf(ReactMediumZoom)).call.apply(_ref, [this].concat(args))), _this), _this.imgRef = React.createRef(), _this.zoom = null, _this.open = function () {
      return _this.zoom.open();
    }, _temp), possibleConstructorReturn(_this, _ret);
  }

  createClass(ReactMediumZoom, [{
    ...
    value: function render() {
      var imgProps = objectWithoutProperties(this.props, []);


      return React.createElement('img', _extends$1({
        ref: this.imgRef
      }, imgProps));
    }
  }]);
  return ReactMediumZoom;
}(Component);
