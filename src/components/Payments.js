  ...
  render() {
    return (
      <div class="divmob min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16 px-48">
        <div class="pgePrece w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700">
          ...
          </div>    <div class="mb-3 flex -mx-2 justify-center mb-10">
            <div class="px-2">
          ...
          <div class="dropdown mb-3 flex -mx-2 justify-center mb-10">
            <div class="px-2 border-2 border-gray-200 px-5 py-2  ml-5 ">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" value={this.state.type}
                  onChange={e => this.handleChange(e)} id="paiment1" checked />
                <p class=" font-bold pl-2"> 5 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5 ">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" value={this.state.type}
                  onChange={e => this.handleChange(e)} id="paiment2" checked />
                <p class=" font-bold pl-2"> 10 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" value={this.state.type}
                  onChange={e => this.handleChange(e)} id="paiment3" checked />
                <p class=" font-bold pl-2"> 15 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="paiment4" checked value={this.state.type}
                  onChange={e => this.handleChange(e)} />
                <p class=" font-bold pl-2"> 20 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="paiment5" checked value={this.state.type}
                  onChange={e => this.handleChange(e)} />
                <p class=" font-bold pl-2"> 25 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="paiment6" checked value={this.state.type}
                  onChange={e => this.handleChange(e)} />
                <p class=" font-bold pl-2"> 30 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="paiment7" checked value={this.state.type}
                  onChange={e => this.handleChange(e)} />
                <p class=" font-bold pl-2"> 50 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="paiment8" checked value={this.state.type}
                  onChange={e => this.handleChange(e)} />
                <p class=" font-bold pl-2"> 100 €</p>
              </label>
            </div>
            <div class="px-2 border-2 border-gray-200 px-5 py-2 ml-5">
              <label for="type1" class="flex items-center cursor-pointer">
                <input type="radio" class="form-radio h-5 w-5 text-indigo-500" name="type" id="paiment9" checked value={this.state.type}
                  onChange={e => this.handleChange(e)} />
                <input class=" font-bold pl-2 text-black " placeholder="autre montant..€" type="text" />
              </label>
            </div>
          </div>
          ...
          >
            {close => (
              <div>
                ...
                <div class=" w-full text-xl text-white text-center items-center bg-black" > Merci ! Votre don a bien été pris en compte </div>
                ...
                <div class="">
                  ...
                  <a href="CleanDay"> <button
                    class="popupButt ml-80 border-dashed border-2 border-black px-2 bg-gray-100 "
                    onClick={() => {
